...
public class MaterialProgressBar extends ImageView {
    ...
    private static final int KEY_SHADOW_COLOR = 0xFFFFFF;
    private static final int FILL_SHADOW_COLOR = 0xFFFFFF;
    // PX
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!elevationSupported()) {
            setMeasuredDimension(getMeasuredWidth() + mShadowRadius * 8, getMeasuredHeight()
                    + mShadowRadius * 8);
        }
    }
